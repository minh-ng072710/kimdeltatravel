...
class ATDTP
{
	...
	public function action_load_assets() {
		...
		wp_enqueue_style( 'atdtp-plugin-shortcodes', $this->get_plugin_url() . 'assets/css/style.css', null, self::VERSION );
		wp_enqueue_style( 'atdtp-plugin-font-awesome', $this->get_plugin_url() . 'assets/css/font-awesome.min.css', null, self::VERSION );
	}
