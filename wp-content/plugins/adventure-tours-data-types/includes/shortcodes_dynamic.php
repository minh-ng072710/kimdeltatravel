...
if ( ! shortcode_exists( 'tour_carousel' ) ) {
	...
	$sc_helper->add_shortcode( 'tour_carousel', 'atdpt_shortcode_tour_carousel', array(
		...
		'params' => array(
			...
			'order' => array(
				'type' => 'dropdown',
				'value' => $sc_helper->get_order_values( 'tours_order' ),
			),
			'orderby' => array(
				'type' => 'dropdown',
				'value' => $sc_helper->get_order_values( 'tours_orderby' ),
			),
		),
	) );
}
...
if ( ! shortcode_exists( 'product_carousel' ) ) {
	...
	$sc_helper->add_shortcode( 'product_carousel', 'atdpt_shortcode_product_carousel', array(
		...
		'params' => array(
			...
			'order' => array(
				'type' => 'dropdown',
				'value' => $sc_helper->get_order_values( 'products_order' ),
			),
			'orderby' => array(
				'type' => 'dropdown',
				'value' => $sc_helper->get_order_values( 'products_orderby' ),
			),
		),
	) );
}
