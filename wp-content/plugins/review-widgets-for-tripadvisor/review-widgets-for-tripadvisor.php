...
<button class="button button-primary"><?php echo TrustindexPlugin_tripadvisor::___("Sure, you deserve it"); ?></button>
</a>
...
<button class="button button-secondary"><?php echo TrustindexPlugin_tripadvisor::___("Maybe later"); ?></button>
</a>
...
<button class="button button-secondary" style="float: right"><?php echo TrustindexPlugin_tripadvisor::___("Do not remind me again"); ?></button>
</a>
</p>
</div>
<?php
...
if(isset($_REQUEST['test']) && $token == get_option($trustindex_pm_tripadvisor->get_option_name('review-download-token')))
{
echo $token;
exit;
}
...
if(
!$token
|| !$trustindex_pm_tripadvisor->is_noreg_linked()
|| $our_token != $token
) {
global $wp_query;
$wp_query->set_404();
...
{
$trustindex_pm_tripadvisor->save_details($_REQUEST['details']);
$trustindex_pm_tripadvisor->save_reviews(isset($_REQUEST['reviews']) ? $_REQUEST['reviews'] : []);
}
...
<button class="button button-primary"><?php echo TrustindexPlugin_tripadvisor::___("Create website widget now! »"); ?></button>
</a>
</p>
</div>
<?php
