...
<?php endif; ?>
<div class="ti-box">
<div class="ti-header"><?php echo TrustindexPlugin_tripadvisor::___("My Reviews"); ?></div>
<?php if(!$is_review_download_in_progress): ?>
<div class="tablenav top" style="margin-bottom: 26px">
<div class="alignleft actions">
<?php if($download_timestamp < time()): ?>
<a href="?page=<?php echo esc_attr($_GET['page']); ?>&tab=setup_no_reg&refresh&my_reviews" class="btn-text btn-refresh btn-download-reviews" style="margin-left: 0" data-loading-text="<?php echo TrustindexPlugin_tripadvisor::___("Loading") ;?>" data-delay=10><?php echo TrustindexPlugin_tripadvisor::___("Download new reviews") ;?></a>
<?php else: ?>
...
<p>
<?php echo TrustindexPlugin_tripadvisor::___("Don't want to waste your time by updating your reviews every week? <a href='%s' target='_blank'>Create a free Trustindex account! »</a>", [ 'https://www.trustindex.io/ti-redirect.php?a=sys&c=wp-tripadvisor-l' ]); ?>
</p>
</div>
<?php endif; ?>
...
<th style="width: 48%"><?php echo TrustindexPlugin_tripadvisor::___("Text"); ?></th>
<th></th>
</tr>
</thead>
<tbody>
...
<td>
<a href="<?php echo esc_attr($review->id); ?>" class="btn-text btn-highlight<?php if(isset($review->highlight) && $review->highlight): ?> has-highlight<?php endif; ?>" style="margin-left: 0"><?php echo TrustindexPlugin_tripadvisor::___("Highlight text") ;?></a>
</td>
</tr>
<?php endforeach; ?>
</tbody>
...
<a href="#" class="btn-text btn-modal-close"><?php echo TrustindexPlugin_tripadvisor::___("Back") ;?></a>
<a href="#" class="btn-text btn-primary btn-highlight-confirm" data-loading-text="<?php echo TrustindexPlugin_tripadvisor::___("Loading") ;?>"><?php echo TrustindexPlugin_tripadvisor::___("Save") ;?></a>
<a href="#" class="btn-text btn-danger btn-highlight-remove" style="position: absolute; left: 15px" data-loading-text="<?php echo TrustindexPlugin_tripadvisor::___("Loading") ;?>"><?php echo TrustindexPlugin_tripadvisor::___("Remove highlight") ;?></a>
</div>
</div>
</div>
</div>
...
<div class="ti-box">
<div class="ti-header"><?php echo TrustindexPlugin_tripadvisor::___('Collect reviews automatically for your WooCommerce shop'); ?></div>
