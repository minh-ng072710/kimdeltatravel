...
<br />
<a href="#" id="review-manual-download" class="button button-primary ti-tooltip" style="margin-top: 10px" data-loading-text="<?php echo TrustindexPlugin_tripadvisor::___("Loading") ;?>">
...
<a href="?page=<?php echo esc_attr($_GET['page']); ?>&tab=setup_no_reg&command=delete-page"><button class="btn btn-text"><?php echo TrustindexPlugin_tripadvisor::___("Disconnect") ;?></button></a>
<div class="clear"></div>
</div>
<?php else: ?>
<div class="ti-box">
...
<button class="btn btn-text btn-connect" data-loading-text="<?php echo TrustindexPlugin_tripadvisor::___("Loading") ;?>"><?php echo TrustindexPlugin_tripadvisor::___("Connect") ;?></button>
</div>
<div class="clear"></div>
</div>
...
<a href="?page=<?php echo $_GET['page']; ?>&tab=setup_no_reg&command=save-style&style_id=<?php echo esc_attr(urlencode($id)); ?>" class="btn-text btn-refresh ti-pull-right" data-loading-text="<?php echo TrustindexPlugin_tripadvisor::___("Loading") ;?>"><?php echo TrustindexPlugin_tripadvisor::___("Select") ;?></a>
<div class="clear"></div>
</div>
<div class="preview">
<?php echo $trustindex_pm_tripadvisor->get_noreg_list_reviews(null, true, $id, 'light-background', true, true); ?>
</div>
</div>
</div>
<?php endforeach; ?>
...
<a href="?page=<?php echo esc_attr($_GET['page']); ?>&tab=setup_no_reg&command=save-set&set_id=<?php echo esc_attr(urlencode($id)); ?>" class="btn-text btn-refresh ti-pull-right" data-loading-text="<?php echo TrustindexPlugin_tripadvisor::___("Loading") ;?>"><?php echo TrustindexPlugin_tripadvisor::___("Select") ;?></a>
<div class="clear"></div>
</div>
<div class="preview">
...
<div class="ti-box">
<div class="ti-header"><?php echo TrustindexPlugin_tripadvisor::___('Widget Settings'); ?></div>
...
<?php endif; ?>
<?php if(!in_array($style_id, [ 11, 17, 18, 21, 24, 25, 26, 27, 28, 29, 30, 35 ]) && TrustindexPlugin_tripadvisor::$widget_styles[$scss_set]['_vars']['dots'] !== 'true'): ?>
<span class="ti-checkbox row">
...
<div class="clear"></div>
<div class="ti-footer">
<a href="?page=<?php echo esc_attr($_GET['page']); ?>&tab=setup_no_reg&setup_widget" class="btn-text btn-refresh ti-pull-right" data-loading-text="<?php echo TrustindexPlugin_tripadvisor::___("Loading") ;?>"><?php echo TrustindexPlugin_tripadvisor::___("Save and get code") ;?></a>
<div class="clear"></div>
</div>
</div>
<?php else: ?>
...
<?php endif; ?>
<div class="ti-box">
<div class="ti-header"><?php echo TrustindexPlugin_tripadvisor::___('Insert this shortcode into your website'); ?></div>
...
<div class="ti-header"><?php echo TrustindexPlugin_tripadvisor::___("How's experience with Trustindex?"); ?></div>
...
<div class="ti-box">
<div class="ti-header"><?php echo TrustindexPlugin_tripadvisor::___('Increase SEO, trust and sales using customer reviews.'); ?></div>
...
<li>
<strong><?php echo TrustindexPlugin_tripadvisor::___("%d review platforms", [ 58 ]); ?></strong><br />
...
<a href="#" class="btn-text btn-modal-close"><?php echo TrustindexPlugin_tripadvisor::___('Cancel') ;?></a>
<a href="#" class="btn-text btn-rateus-support" data-loading-text="<?php echo TrustindexPlugin_tripadvisor::___('Loading') ;?>"><?php echo TrustindexPlugin_tripadvisor::___('Contact our support') ;?></a>
</div>
</div>
</div>
</div>
