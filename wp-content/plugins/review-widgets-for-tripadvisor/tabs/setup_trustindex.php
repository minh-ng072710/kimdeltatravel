...
<h2>
<?php echo TrustindexPlugin_tripadvisor::___('%s+ WordPress websites use Trustindex to embed reviews fast and easily.', [ '100.000' ]); ?><br />
...
<li><?php echo TrustindexPlugin_tripadvisor::___("%d review platforms", [ 58 ]); ?></li>
