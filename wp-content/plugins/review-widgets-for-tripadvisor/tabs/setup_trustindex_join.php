...
<?php endif; ?>
<div class="ti-box">
<div class="ti-header"><?php echo TrustindexPlugin_tripadvisor::___('Connect your Trustindex account'); ?></div>
...
<button class="btn btn-text" type="submit" style="margin-top: 20px; margin-bottom: 0"><?php echo TrustindexPlugin_tripadvisor::___("Disconnect"); ?></button>
</div>
</form>
<?php else: ?>
<div class="ti-row">
...
<button type="submit" class="btn btn-primary" data-loading-text="<?php echo TrustindexPlugin_tripadvisor::___("Loading") ;?>"><?php echo TrustindexPlugin_tripadvisor::___('CONNECT ACCOUNT');?></button>
<br />
<p class="text-center">
<a class="btn-text" href="<?php echo 'https://admin.trustindex.io/'; ?>forgot-password" target="_blank"><?php echo TrustindexPlugin_tripadvisor::___('Have you forgotten your password?'); ?></a>
<a class="btn-text" href="https://www.trustindex.io/ti-redirect.php?a=sys&c=wp-tripadvisor-4" target="_blank"><?php echo TrustindexPlugin_tripadvisor::___('Create a new Trustindex account');?></a>
</p>
</form>
...
<div class="ti-header"><?php echo TrustindexPlugin_tripadvisor::___("Manage your Trustindex account"); ?></div>
...
<div class="ti-box">
<div class="ti-header"><?php echo TrustindexPlugin_tripadvisor::___("Insert your widget into your wordpress site using shortcode"); ?></div>
<?php if($trustindex_subscription_id): ?>
