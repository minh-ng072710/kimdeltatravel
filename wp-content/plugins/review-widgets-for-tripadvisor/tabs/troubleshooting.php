...
$plugin_updated = ($trustindex_pm_tripadvisor->get_plugin_current_version() <= "9.5.1");
...
?>
<div class="ti-box">
<div class="ti-header"><?php echo TrustindexPlugin_tripadvisor::___("Troubleshooting"); ?></div>
...
<li><?php echo TrustindexPlugin_tripadvisor::___('Navigate to'); ?> "Settings" > "WP Rocket menu" > "File optimization"</li>
<li><?php echo TrustindexPlugin_tripadvisor::___('Scroll to'); ?> "Excluded Javascript files"</li>
...
CSS path: <?php echo esc_html($trustindex_pm_tripadvisor->getCssFile()) ."\n\n"; ?>
PHP Info: <?php echo "\n\t"; ?>
...
<div class="ti-box">
<div class="ti-header"><?php echo TrustindexPlugin_tripadvisor::___("Re-create plugin"); ?></div>
...
<a href="?page=<?php echo esc_attr($_GET['page']); ?>&tab=setup_no_reg&recreate" class="btn-text btn-refresh ti-pull-right" data-loading-text="<?php echo TrustindexPlugin_tripadvisor::___("Loading") ;?>" style="margin-left: 0"><?php echo TrustindexPlugin_tripadvisor::___("Re-create plugin"); ?></a>
<div class="clear"></div>
</div>
<div class="ti-box">
<div class="ti-header"><?php echo TrustindexPlugin_tripadvisor::___("Translation"); ?></div>
<p>
