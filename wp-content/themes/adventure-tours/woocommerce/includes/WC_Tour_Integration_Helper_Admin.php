...
/*** Tour Booking tab management implementation [start] ***/
	...
	public function filter_woocommerce_product_write_panels() {
		wp_enqueue_script( 'theme-tools', PARENT_URL . '/assets/admin/ThemeTools.js', array('jquery'), '4.2.1' );
		wp_enqueue_script( 'tour-booking-tab', PARENT_URL . '/assets/admin/AdminTourBookingTab.js', array('jquery'), '4.2.1' );
