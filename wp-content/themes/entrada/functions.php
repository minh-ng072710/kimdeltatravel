...
if (!function_exists('entrada_widgets_init')) {
	function entrada_widgets_init()
	{
		...
		$footer_widget_column = ($footer_widget_column ? $footer_widget_column : 3);
...
require get_template_directory() . '/vc_templates/thuexe.php';
...
function register_strings() {
    pll_register_string('gia-ghep-doan', 'Giá ghép đoàn');
    pll_register_string('gia-tour-nhom-le', 'Giá tour nhóm lẻ');
    pll_register_string('thoi-gian', 'Thời gian');
    pll_register_string('phuong-tien', 'Phương tiện');
    pll_register_string('diem-xuat-phat', 'Điểm xuất phát');
    pll_register_string('diem-den', 'Điểm đến');
    pll_register_string('dat-ngay ngay', 'Đặt ngay');
    pll_register_string('chinh-sach-tour', 'Chính sách tour');
    pll_register_string('chinh-sach-tour', 'Chương trình tour');
    pll_register_string('hinh-anh', 'Hình ảnh');
    pll_register_string('kham-pha', 'Khám phá');
}
