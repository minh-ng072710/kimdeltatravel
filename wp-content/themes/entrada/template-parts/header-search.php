			...
			<div class="search-wrap">
				...
				<div class="trip-form trip-form-v2 trip-search-main">
					<div class="trip-form-wrap">
						<div class="holder">
							<label><?php _e('Khởi hành',  'entrada'); ?></label>
							<div class='select-holder'>
								<?php echo entrada_header_dateform_selector('start_date'); ?>
							</div>
						</div>
						<div class="holder">
							<label><?php _e('Kết thúc',  'entrada'); ?></label>
							<div class='select-holder'>
...
//										}
						...
						<div class="holder">
							<label><?php _e('Chọn tour',  'entrada'); ?></label>
							<div class='select-holder'>
								<select class="trip-select trip-select-v2 acitvity" name="product_cat" id="select-activity">
									<option value="" class="hideme"><?php _e('Tour',  'entrada'); ?></option>
									<option value=""><?php _e('Tất cả Tour',  'entrada'); ?></option>
									<?php
										if (class_exists('WooCommerce')) {
...
<!--						<div class="holder">
						...
						<div class="holder">
							<button class="btn btn-trip btn-trip-v2" type="submit">
								<?php _e('Tìm tour',  'entrada'); ?></button>
						</div>
					</div>
				</div>
			</div>
